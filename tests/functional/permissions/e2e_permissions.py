...
class TestPermissions(BaseResdkFunctionalTest):
    ...
    def test_get_holders_with_perm(self):
        ...
        self.assertEqual(self.test_collection.permissions.editors[0].get_name(), "admin")
        ...
        self.assertEqual(self.test_collection.permissions.viewers[0].first_name, "admin")
